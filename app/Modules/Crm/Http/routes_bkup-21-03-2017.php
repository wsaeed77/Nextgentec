...
Route::get('/user_files/{folder}/_thumb/{filename}', ['as'=>'get.user_files.thumb', 'uses' => 'FilemanagerController@retrieveThumb']);

Route::get('/user_files/{folder}/{filename}', ['as'=>'get.user_files.file', 'uses' => 'FilemanagerController@retrieveFile']);
...
Route::group(['prefix' => 'admin','middleware' => 'admin'], function () {
    ...
    Route::group(['prefix' => 'crm','middleware' => ['role:admin|manager|technician']], function () {
        ...
        Route::get('/ajax_click_call/{id}', ['as'=>'admin.crm.ajax.click_call','middleware' => ['permission:edit_customer'], 'uses' => 'CrmController@ajaxClicktoCall']);
      ...
      /********************************************************* Angular *****************************/
        ...
        //default rates
        Route::get('/list_default_rates', ['as'=>'admin.crm.default_rates', 'uses' => 'DefaultRates@index']);
