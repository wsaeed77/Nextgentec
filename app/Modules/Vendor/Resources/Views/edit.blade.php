...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <i class="fa fa-table"></i> Edit Vendor
        </li>
    </ol>
@endsection
                        ...
                        <div id="vendor_add" >
                           <div class="form-group col-lg-4">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                {!! Form::textarea('dialing_instructions',$vendor->dailing_instructions, ['placeholder'=>"Dialing instructions",'id'=>'instructions','class'=>"form-control",'rows'=>2]) !!}
                            </div>
                        </div>
                    <div class="clearfix"></div>
                   </div>
