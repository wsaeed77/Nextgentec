 ...
 <script src="{{URL::asset('DataTables/datatables.min.js')}}"></script>
  ...
  @include('assets::ajax_functions')
    ...
    var table = $('#vendor_dt_table').DataTable({
        ...
        pageLength: 25,
        order: [[ 2, "desc" ]],
        ajax: '{!! route('admin.vendors.vendor_index_cust_dashboard') !!}',
        ...
        columns: [
            ...
            { data: 'location', name: 'location',className: "clickable" },
 ...
 //console.log(settings);
      ...
      $('#vendor_dt_table tbody ').on( 'click', 'tr>td.clickable', function (e) {
        ...
        if ( $(this).hasClass('selected') ) {
          ...
          $.get("/admin/vendors/ajax_detail/"+table.row( this ).data().id+'/'+table.row( this ).data().pivot.location_id,function(data) {
